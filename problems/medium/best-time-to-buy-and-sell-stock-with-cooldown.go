/*
 * @Author: hongwei.sun
 * @Date: 2024-04-08 23:52:08
 * @LastEditors: hongwei.sun
 * @LastEditTime: 2024-04-09 10:43:30
...
The key for dp is to find the variables to represent the states 
...
cooldown[i] means before day i what is the maxProfit for any sequence end with rest.
...
(1) We have to `cooldown` before we `buy` and
...
// this is another dp solution with cooldown array
func maxProfit(prices []int) int {
	if len(prices) <= 1 {
		return 0
	}
